...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 8, minZoom: 20, projection: new ol.proj.Projection({
            code: 'EPSG:32643',
...
map.getView().fit([273678.109238, 2114974.236673, 274781.411990, 2115814.236673], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_BuildingFootprints_1,
    colName: 'BLDG_USE',
    zoom: 10,
    collapsed: true,
    map: map
